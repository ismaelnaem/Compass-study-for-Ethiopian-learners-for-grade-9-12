...
import { 
  ...
  HelpCircle, AlertCircle, Sparkle, X, CheckCircle
} from "lucide-react";
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<"Home" | "Books" | "Coach" | "Progress" | "Profile" | "Quiz">("Home");
  ...
  const handleQuizCompleted = (scorePercentage: number) => {
    if (!selectedSubUnit || !profile) return;
