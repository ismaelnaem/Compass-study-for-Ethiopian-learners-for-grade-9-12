...
export const NOTIFICATION_TEMPLATES: Record<NotificationKey, Record<Language, NotificationTemplate>> = {
  dailyMorning: {
    ...
    Tigrinya: { title: "ሰናይ ንግሆ! 🌅", body: "ሎሚ ንGrade {grade} ሒደት ደቓይቕ ምሃብ ንቕድሚት የስጉመካ እዩ። ድሉው ዲኻ፧" },
  },
  dailyAfternoon: {
    ...
    Tigrinya: { title: "ዕረፍቲ መጽናዕቲ? 📚", body: "10 ደቓይቕ ክህልወካ ከሎ ናይ {subject} ትምህርትኻ ይጽበየካ ኣሎ።" },
  },
  dailyEvening: {
    ...
    Tigrinya: { title: "ነዛ መዓልቲ ብጽቡቕ ዛዝማ 🌙", body: "ኣብ {subject} ካብቲ ዘቋረጽካዮ ቀጽል።" },
  },
  streakRisk: {
    ...
    Tigrinya: { title: "ተከታታሊ ዓወትካ ኣይተቋርጽ! 🔥", body: "ን{streak} መዓልታት ብተኸታታሊ ኣጽኒዕካ ኣለኻ — ሎሚ እውን ብምጽናዕ ኣቐጽሎ።" },
  },
  weakSubject: {
    ...
    Tigrinya: { title: "ንትምህርቲ {subject} ነሐይሎ 💪", body: "ትምህርቲ {subject} ሒደት ከቢድካ ክኸውን ይኽእል እዩ — ሎሚ ሓደ ኣርእስቲ ምርኣይ ክሕግዘካ ይኽእል።" },
  },
  reengagement: {
    ...
    Tigrinya: { title: "ኣብ Compass Study ናፊቕናካ ኣለና 🧭", body: "ዝዓመምካዮ መጽናዕቲ ተዓቂቡ ኣሎ — ልክዕ ካብቲ ዘቋረጽካዮ ቀጽል።" },
  },
  examApproaching: {
    ...
    Tigrinya: { title: "ፈተናታት ይቐርቡ ኣለዉ 📅", body: "መዓልታዊ ሒደት ናይ {subject} ልምምድ ምግባር ዓቢ ለውጢ የምጽእ እዩ። ብሓባር ክለሳ ንግበር።" },
  },
  quotaReached: {
    ...
    Tigrinya: { title: "ናይ ሎሚ ነጻ ሕቶታት AI ተጠቂምካ ኣለኻ 🎯", body: "ምስ AI Coach ብዘይገደብ ንምዕላል መለያኻ ኣሐድስ (Upgrade)።" },
  },
  newChatMessage: {
    ...
    Tigrinya: { title: "ካብ {senderName} ሓድሽ መልእኽቲ መጺኡ ኣሎ 💬", body: "ብዛዕባ ገስጋስ {studentName} ምላሽ ንምሃብ ጠውቕ።" },
  },
  chatLimitWarning: {
    ...
    Tigrinya: { title: "ንሎሚ ውሑዳት መልእኽትታት ጥራይ ተሪፎም ኣለዉ", body: "ኣብዚ ዕላል {remaining} መልእኽትታት ጥራይ ተሪፎምኻ ኣለዉ።" },
  },
  newFileFromTeacher: {
    ...
    Tigrinya: { title: "ሓድሽ ፋይል ካብ {teacherName} 📎", body: "ንክፍሊ {className} ዝተኻፈለ ነገር ኣሎ — ንምርኣይ ጠውቕ።" },
  },
  connectionAccepted: {
    ...
    Tigrinya: { title: "ተራኺብካ ኣለኻ! ✅", body: "ሕጂ {name} ናይ መጽናዕትኻ ገስጋስ ክርኢ ይኽእል እዩ።" },
  },
};
